...
KERNEL_SPECS="oneplus5;oos;oos4xx;http://kernel.boeffla.de/oneplus5/boeffla-kernel-oos/;boeffla-kernel-#VERSION#-OOS4xx-OnePlus5-anykernel.recovery.zip"
